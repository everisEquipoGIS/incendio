...
const pd100 = capas.find(capa => capa.name === "Hectáreas con pendiente de 51-100%");
const mato50 = capas.find(capa => capa.name === "Hectáreas con FCC arbustiva < 50%");
const mato100 = capas.find(capa => capa.name === "Hectáreas con FCC arbustiva mayor o igual al 50%");
const eucaliptus50 = capas.find(capa => capa.name === "Hectáreas de eucaliptar cobertura < 50%");
const eucaliptus100 = capas.find(capa => capa.name === "Hectáreas de eucaliptar cobertura > 50%");
const pinus50 = capas.find(capa => capa.name === "Hectáreas de pinar cobertura < 50%");
const pinus100 = capas.find(capa => capa.name === "Hectáreas de pinar cobertura > 50%");
const quercus50 = capas.find(capa => capa.name === "Hectáreas de encinar cobertura < 50%");
const quercus100 = capas.find(capa => capa.name === "Hectáreas de encinar cobertura > 50%");
const arbol25 = capas.find(capa => capa.name === "Hectáreas donde la FCC arbórea se encuentra entre el 1-25%");
const arbol50 = capas.find(capa => capa.name === "Hectáreas donde la FCC arbórea se encuentra entre el 26-50%");
const arbol75 = capas.find(capa => capa.name === "Hectáreas donde la FCC arbórea se encuentra entre el 51-75%");
const arbol100 = capas.find(capa => capa.name === "Hectáreas donde la FCC arbórea se encuentra entre el 76-100%");
...
const amenaz = capas.find(capa => capa.name === "Indica si es probable que aparezca alguna especie incluida en el catálogo de especies amenazadas");
